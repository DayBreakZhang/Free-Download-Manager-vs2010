...
template <>
struct PrototypeIDMap<mozilla::dom::indexedDB::IDBFactory>
{
  enum
  {
    PrototypeID = prototypes::id::IDBFactory
  };
};
} // namespace dom
} // namespace mozilla
...
namespace IDBFactoryBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::IDBFactory];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::IDBFactory];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::IDBFactory];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::IDBFactory];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::dom::indexedDB::IDBFactory* aObject, nsWrapperCache* aCache);
