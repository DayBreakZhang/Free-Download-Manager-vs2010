...
template <>
struct PrototypeIDMap<mozilla::dom::HTMLOptionsCollection>
{
  enum
  {
...
namespace HTMLOptionsCollectionBinding {
  ...
  public:
    ...
    bool
    defineProperty(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, JSPropertyDescriptor* desc);
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::dom::HTMLOptionsCollection* aObject, nsWrapperCache* aCache);
