...
template <>
struct PrototypeIDMap<mozilla::dom::SpeechRecognitionResult>
{
  enum
  {
    PrototypeID = prototypes::id::SpeechRecognitionResult
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SpeechRecognitionResultBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SpeechRecognitionResult];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SpeechRecognitionResult];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SpeechRecognitionResult];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SpeechRecognitionResult];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::dom::SpeechRecognitionResult* aObject, nsWrapperCache* aCache);
