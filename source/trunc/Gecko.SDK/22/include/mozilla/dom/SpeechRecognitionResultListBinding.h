...
template <>
struct PrototypeIDMap<mozilla::dom::SpeechRecognitionResultList>
{
  enum
  {
    PrototypeID = prototypes::id::SpeechRecognitionResultList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SpeechRecognitionResultListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SpeechRecognitionResultList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SpeechRecognitionResultList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SpeechRecognitionResultList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SpeechRecognitionResultList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::dom::SpeechRecognitionResultList* aObject, nsWrapperCache* aCache);
