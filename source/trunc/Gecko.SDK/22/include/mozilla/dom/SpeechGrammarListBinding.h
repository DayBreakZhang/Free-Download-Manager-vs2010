...
template <>
struct PrototypeIDMap<mozilla::dom::SpeechGrammarList>
{
  enum
  {
    PrototypeID = prototypes::id::SpeechGrammarList
  };
};
} // namespace dom
} // namespace mozilla
...
namespace SpeechGrammarListBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    JSObject* cachedObject = protoAndIfaceArray[prototypes::id::SpeechGrammarList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[prototypes::id::SpeechGrammarList];
    }
  ...
  inline JSObject* GetConstructorObject(JSContext* aCx, JSObject* aGlobal)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoAndIfaceArray = GetProtoAndIfaceArray(aGlobal);
    JSObject* cachedObject = protoAndIfaceArray[constructors::id::SpeechGrammarList];
    if (!cachedObject) {
      CreateInterfaceObjects(aCx, aGlobal, protoAndIfaceArray);
      cachedObject = protoAndIfaceArray[constructors::id::SpeechGrammarList];
    }
  ...
  JSObject*
  Wrap(JSContext* aCx, JSObject* aScope, mozilla::dom::SpeechGrammarList* aObject, nsWrapperCache* aCache);
